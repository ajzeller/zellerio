window.sr = ScrollReveal();
    ...
    // slide in from left
    sr.reveal('.animate3', { scale: 1, duration: 500, origin: 'left', distance:'30px', viewFactor: .3, easing: 'cubic-bezier(1, 0.5, 0.5, .5)'});

    // slide in from right
    sr.reveal('.animate4', { scale: 1, duration: 500, origin: 'right', distance:'30px', viewFactor: .3, easing: 'cubic-bezier(1, 0.5, 0.5, .5)'});
